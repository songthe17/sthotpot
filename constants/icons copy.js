...
export const setting2 = require('../assets/icons/setting2.png');
export const location2 = require('../assets/icons/location2.png');
export const hotpot = require('../assets/icons/hotpot.png');
export const deliveryman = require('../assets/icons/deliveryman.png');
export const notification = require('../assets/icons/notification.png');
export const friend = require('../assets/icons/friends.png');
export const checkout = require('../assets/icons/checkout.png');
export const help = require('../assets/icons/help.png');
export const home1 = require('../assets/icons/home.png');
