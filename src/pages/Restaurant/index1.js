...
const Restaurant1 = ({route, navigation}) => {
      ...
      <View>
        ...
        <View
          ...
          <View
            ...
            <Text style={{...FONTS.h4}}>Chọn chỗ:</Text>
            <View
              style={{
                marginLeft: 20,
                height: 50,
              ...
              <TouchableOpacity
                ...
                <Text style={{...FONTS.h4}}>2 Người</Text>
              </TouchableOpacity>
              <TouchableOpacity
                style={{
                  padding: SIZES.padding,
                ...
                <Text style={{...FONTS.h4}}>4 Người</Text>
              </TouchableOpacity>
              <TouchableOpacity
                style={{
                  padding: SIZES.padding,
                ...
                <Text style={{...FONTS.h4}}>6 Người</Text>
              </TouchableOpacity>
            </View>
          </View>
          <View
            ...
            <Text style={{...FONTS.h4}}>Chọn thời gian:</Text>
            <View
              style={{
                marginLeft: 20,
                height: 50,
